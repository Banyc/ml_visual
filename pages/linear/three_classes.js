...
export function setup() {
    ...
    adaline_learn.addEventListener("click", function(ev) {
        learn_and_draw(pixels_wrapper)
    })

    draw_canvas(pixels_wrapper)
}

function learn_and_draw(pixels_wrapper) {
    ...
    const param_0_new = lib.adaline_learn_multiclass(examples, 0, param_0, learning_rate)
    ...
    const param_1_new = lib.adaline_learn_multiclass(examples, 1, param_1, learning_rate)
    ...
    const param_2_new = lib.adaline_learn_multiclass(examples, 2, param_2, learning_rate)
